...
public class ProcessPaymentDoneStrategy : IKafkaEventProcessorStrategy
{
    ...
    private const string TOPIC = "e-order-management.order-payment-done-status-changed";
    ...
    public async Task ProcessAsync(string message)
    {
        ...
        _logger.LogInformation($"ProcessPaymentDoneStrategy - Processing - EventName: {orderEvent.EventName}");
