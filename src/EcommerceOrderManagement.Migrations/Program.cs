    ...
    static void SeedDatabase(OrderManagementDbContext context)
    {
        ...
        if (!context.Products.Any())
        {
              var products = new List<Product>
              {
                ...
                new Product { Id = new Guid("8b07897d-6c9c-4e2e-b9dc-08dcda79fcdf"), Name = "Fones de Ouvido", Description = "Fones de ouvido com cancelamento de ruído", Price = 999.99m, CategoryId = context.ProductCategories.First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 20, OwnerName = "Juliana Lima", OwnerEmail = "juliana.lima@example.com" },
                new Product { Name = "Tablet", Description = "Tablet portátil", Price = 1299.99m, CategoryId = context.ProductCategories.First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 90, OwnerName = "Fernando Oliveira", OwnerEmail = "fernando.oliveira@example.com" },
                new Product { Name = "Leitor de E-Books", Description = "Leitor de livros digitais", Price = 749.99m, CategoryId = context.ProductCategories.First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 10, OwnerName = "Mariana Santos", OwnerEmail = "mariana.santos@example.com" },
                new Product { Name = "Romance", Description = "Romance best-seller", Price = 29.99m, CategoryId = context.ProductCategories.Skip(1).First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 60, OwnerName = "Lucia Almeida", OwnerEmail = "lucia.almeida@example.com" },
                new Product { Name = "Camiseta", Description = "Camiseta de algodão", Price = 59.99m, CategoryId = context.ProductCategories.Skip(2).First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 100, OwnerName = "Thiago Martins", OwnerEmail = "thiago.martins@example.com" },
                new Product { Name = "Sofá", Description = "Sofá confortável", Price = 999.99m, CategoryId = context.ProductCategories.Skip(3).First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 40, OwnerName = "Sofia Rocha", OwnerEmail = "sofia.rocha@example.com" },
                new Product { Name = "Boneco de Ação", Description = "Boneco de ação colecionável", Price = 229.99m, CategoryId = context.ProductCategories.Skip(4).First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 15, OwnerName = "Gustavo Dias", OwnerEmail = "gustavo.dias@example.com" },
                new Product { Name = "Jogo de Tabuleiro", Description = "Jogo de tabuleiro popular", Price = 139.99m, CategoryId = context.ProductCategories.Skip(4).First().Id, ImageUrl = "https://via.placeholder.com/150", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, StockQuantity = 55, OwnerName = "Isabela Ferreira", OwnerEmail = "isabela.ferreira@example.com" }
              };
